...
/** @type {string} */
const CACHE_VERSION = '1769196036|3899959248';
/** @type {string} */
const CACHE_PREFIX = 'First Game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'First Game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["First Game.html","First Game.js","First Game.offline.html","First Game.icon.png","First Game.apple-touch-icon.png","First Game.audio.worklet.js","First Game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["First Game.wasm","First Game.pck"];
